...
Write R code that answers the following questions for the station 2 data, i.e., `ne.station.2` vector. Write your answers in an R code chunk and use comments to denote which question your line(s) of code answer. As in Exercise 1, write your answer in a commented line after your code for each question.

1. How many temperature readings were taken at station 2? `## Place Answer Here`
    ```{r}
    length(ne.station.2)
    ```
    
2. What date was the:
    a. highest temperature recorded? `## Place Answer Here`
    ...
    b. lowest temperature recorded? `## Place Answer Here`
...
3. What was the mean temperature over the record? `## Place Answer Here`
