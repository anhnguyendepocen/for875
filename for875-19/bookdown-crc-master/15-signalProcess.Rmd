...
3. **Filters**: filters allow you to remove out specific portions of a signal at once, or allow you to remove noise from certain signals.
...
```{r waxwing, echo = FALSE, fig.cap = "Two cedar waxwings, possibly pondering whether or not Ross and Rachel will ever get back together (oh wait no that's me as I write this chapter between binge watching Friends)"}
...
```{r spectrogram, fig.cap = "Example spectrogram of Cedar Waxwing calls"}
