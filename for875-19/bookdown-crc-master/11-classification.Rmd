...
The coefficients $\beta_0$ and $\beta_1$ are approximately $\beta_0 =$ `round(coef(diabetes.lr1)[1], 3)` and 
$\beta_1 = $ `round(coef(diabetes.lr1)[2], 3)`. So for example we can estimate the probability that a woman in this population whose glucose level is 150 would be diabetic as
