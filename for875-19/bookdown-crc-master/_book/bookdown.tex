...
\texttt{ggplot2} while the following chapter on the \texttt{graphics}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{)[iris}\OperatorTok{$}\NormalTok{Species], }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species)}
\OperatorTok{>}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }
\OperatorTok{+}\StringTok{     }\DecValTok{19}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }
\OperatorTok{+}\StringTok{     }\DecValTok{19}\NormalTok{))}
\OperatorTok{>}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.setosa}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{~}\StringTok{ }\NormalTok{iris.setosa}\OperatorTok{$}\NormalTok{Sepal.Length), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{1}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.versicolor}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{~}\StringTok{ }\NormalTok{iris.versicolor}\OperatorTok{$}\NormalTok{Sepal.Length), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{2}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(iris.virginica}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{~}\StringTok{ }\NormalTok{iris.virginica}\OperatorTok{$}\NormalTok{Sepal.Length), }
...
\OperatorTok{+}\StringTok{     }\NormalTok{]}
\OperatorTok{+}\StringTok{   }\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(curr.species}\OperatorTok{$}\NormalTok{Sepal.Width }\OperatorTok{~}\StringTok{ }\NormalTok{curr.species}\OperatorTok{$}\NormalTok{Sepal.Length), }
\OperatorTok{+}\StringTok{     }\DataTypeTok{col =}\NormalTok{ i)}
\OperatorTok{+}\StringTok{ }\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length, }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width, }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DecValTok{18}\NormalTok{, }\DecValTok{19}\NormalTok{)[iris}\OperatorTok{$}\NormalTok{Species], }\DataTypeTok{col =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Species, }\DataTypeTok{type =} \StringTok{"b"}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }
\OperatorTok{+}\StringTok{     }\DecValTok{19}\NormalTok{))}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "setosa"}\NormalTok{], }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ }
\OperatorTok{+}\StringTok{   "setosa"}\NormalTok{], }\DataTypeTok{pch =} \DecValTok{17}\NormalTok{, }\DataTypeTok{col =} \DecValTok{1}\NormalTok{, }\DataTypeTok{type =} \StringTok{"b"}\NormalTok{, }\DataTypeTok{xlim =} \KeywordTok{range}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Length), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{ylim =} \KeywordTok{range}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Width), }\DataTypeTok{xlab =} \StringTok{"Sepal Length"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{ylab =} \StringTok{"Sepal Width"}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{lines}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "versicolor"}\NormalTok{], }
\OperatorTok{+}\StringTok{   }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "versicolor"}\NormalTok{], }
\OperatorTok{+}\StringTok{   }\DataTypeTok{pch =} \DecValTok{18}\NormalTok{, }\DataTypeTok{col =} \DecValTok{2}\NormalTok{, }\DataTypeTok{type =} \StringTok{"b"}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{lines}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Length[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "virginica"}\NormalTok{], }
\OperatorTok{+}\StringTok{   }\DataTypeTok{y =}\NormalTok{ iris}\OperatorTok{$}\NormalTok{Sepal.Width[iris}\OperatorTok{$}\NormalTok{Species }\OperatorTok{==}\StringTok{ "virginica"}\NormalTok{], }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{3}\NormalTok{, }\DataTypeTok{type =} \StringTok{"b"}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \FloatTok{6.4}\NormalTok{, }\DataTypeTok{y =} \FloatTok{4.4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{levels}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species)), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{17}\NormalTok{, }\DecValTok{18}\NormalTok{, }
\OperatorTok{+}\StringTok{     }\DecValTok{19}\NormalTok{))}
\end{Highlighting}
...
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{plot}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor_vehicle_theft, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{xlab =} \StringTok{"Burglaries per 100,000 population"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
...
\OperatorTok{+}\StringTok{   }\DataTypeTok{xlab =} \StringTok{"Burglaries per 100,000 population"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary)), }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }
\OperatorTok{+}\StringTok{     }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor_vehicle_theft)))}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{+}\StringTok{   }\DataTypeTok{xlab =} \StringTok{"Burglaries per 100,000 population"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Motor vehicle theft per 100,000 population"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{axes =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary)), }
...
\OperatorTok{+}\StringTok{   }\DataTypeTok{main =} \StringTok{"Burglaries vs motor vehicle theft for US states"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary)), }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }
\OperatorTok{+}\StringTok{     }\KeywordTok{max}\NormalTok{(crime}\OperatorTok{$}\NormalTok{motor_vehicle_theft)), }\DataTypeTok{circles =}\NormalTok{ crime}\OperatorTok{$}\NormalTok{population, }
...
\OperatorTok{>}\StringTok{ }\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{1}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{text}\NormalTok{(crime}\OperatorTok{$}\NormalTok{burglary, crime}\OperatorTok{$}\NormalTok{motor_vehicle_theft, }\DataTypeTok{labels =}\NormalTok{ crime}\OperatorTok{$}\NormalTok{state, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{cex =} \FloatTok{0.9}\NormalTok{, }\DataTypeTok{font =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{hist}\NormalTok{(Newcomb}\OperatorTok{$}\NormalTok{Time, }\DataTypeTok{breaks =} \DecValTok{30}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Histogram"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Time"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{>}\StringTok{ }\KeywordTok{boxplot}\NormalTok{(gdpPercap }\OperatorTok{~}\StringTok{ }\NormalTok{continent, }\DataTypeTok{data =} \KeywordTok{subset}\NormalTok{(gapminder, }
\OperatorTok{+}\StringTok{   }\NormalTok{year }\OperatorTok{==}\StringTok{ }\DecValTok{2002}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{col =} \StringTok{"lightblue"}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{xlab =} \StringTok{"Continent"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"GDP Per-capita"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{boxplot}\NormalTok{(gdpPercap }\OperatorTok{~}\StringTok{ }\NormalTok{continent, }\DataTypeTok{data =} \KeywordTok{subset}\NormalTok{(gapminder, }
\OperatorTok{+}\StringTok{   }\NormalTok{year }\OperatorTok{==}\StringTok{ }\DecValTok{2002}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{, }\DataTypeTok{border =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"lightblue"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"GDP Per-Capita"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Continent"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{horizontal =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{>}\StringTok{ }\KeywordTok{barplot}\NormalTok{(gender.counts, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{ylab =} \StringTok{"Count"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Goals"}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{row.names}\NormalTok{(gender.counts), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{>}\StringTok{ }\NormalTok{gender.counts <-}\StringTok{ }\KeywordTok{table}\NormalTok{(StudentGoals}\OperatorTok{$}\NormalTok{Gender, StudentGoals}\OperatorTok{$}\NormalTok{Goals)}
\OperatorTok{>}\StringTok{ }\KeywordTok{barplot}\NormalTok{(gender.counts, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{ylab =} \StringTok{"Count"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Goals"}\NormalTok{, }\DataTypeTok{beside =} \OtherTok{TRUE}\NormalTok{)}
\OperatorTok{>}\StringTok{ }\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{row.names}\NormalTok{(gender.counts), }
\OperatorTok{+}\StringTok{   }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{pch =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{>}\StringTok{ }\KeywordTok{barplot}\NormalTok{(gdp.india, }\DataTypeTok{xlab =} \StringTok{"Year"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"GDP Per Capita"}\NormalTok{, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{main =} \StringTok{"India's per-capita GDP"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"steelblue2"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{select}\NormalTok{(}\KeywordTok{filter}\NormalTok{(gm, continent }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Asia"}\NormalTok{, }\StringTok{"Europe"}\NormalTok{)), country, }
\OperatorTok{+}\StringTok{   }\NormalTok{year, pop)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{select}\NormalTok{(}\KeywordTok{filter}\NormalTok{(gm, country }\OperatorTok{==}\StringTok{ "Afghanistan"}\NormalTok{), }\KeywordTok{c}\NormalTok{(}\StringTok{"year"}\NormalTok{, }
\OperatorTok{+}\StringTok{   "lifeExp"}\NormalTok{)), }\DataTypeTok{desc =}\NormalTok{ lifeExp)}
\end{Highlighting}
\end{Shaded}
...
6 Afghan~  1977   14880372 Asia         38.4      786.
\end{verbatim}
...
\subsection{Practice Exercise}\label{practice-exercise-13}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-239-1.png}
...
\begin{verbatim}
Error in utils::download.file(url = aurl, destfile = fn, method = "auto", : cannot open URL 'http://srtm.csi.cgiar.org/SRT-ZIP/SRTM_V41/SRTM_Data_GeoTiff/srtm_23_04.ZIP'
\end{verbatim}
...
\NormalTok{  sites1 <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(sites, TOTAL_SITE }\OperatorTok{>=}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{rangeNum[}\DecValTok{1}\NormalTok{] }\OperatorTok{&}\StringTok{ }
\StringTok{    }\NormalTok{TOTAL_SITE }\OperatorTok{<=}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{rangeNum[}\DecValTok{2}\NormalTok{] }\OperatorTok{&}\StringTok{ }\NormalTok{Camp_type }\OperatorTok{==}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{type }\OperatorTok{&}\StringTok{ }
\StringTok{    }\ControlFlowTok{if}\NormalTok{ (input}\OperatorTok{$}\NormalTok{ada) \{}
\NormalTok{      ADA_SITES }\OperatorTok{>}\StringTok{ }\DecValTok{0}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{      ADA_SITES }\OperatorTok{>=}\StringTok{ }\DecValTok{0}
\NormalTok{    \})}
  
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{nrow}\NormalTok{(sites1) }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) \{}
    \KeywordTok{leaflet}\NormalTok{(sites1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{addTiles}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{lng =} \OperatorTok{~}\NormalTok{Long, }
      \DataTypeTok{lat =} \OperatorTok{~}\NormalTok{Lat, }\DataTypeTok{radius =} \DecValTok{5}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{label =} \KeywordTok{mapply}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x, }
\NormalTok{        y) \{}
        \KeywordTok{HTML}\NormalTok{(}\KeywordTok{sprintf}\NormalTok{(}\StringTok{"<em>%s</em><br>%s site(s)"}\NormalTok{, }
          \KeywordTok{htmlEscape}\NormalTok{(x), }\KeywordTok{htmlEscape}\NormalTok{(y)))}
\NormalTok{      \}, sites1}\OperatorTok{$}\NormalTok{FACILITY, sites1}\OperatorTok{$}\NormalTok{TOTAL_SITE))}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
    \KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{addTiles}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{setView}\NormalTok{(}\OperatorTok{-}\FloatTok{84.5555}\NormalTok{, }\FloatTok{42.7325}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\KeywordTok{length}\NormalTok{(diabetes.predict.}\DecValTok{2}\NormalTok{[diabetes.predict.}\DecValTok{2} \OperatorTok{==}\StringTok{ }\NormalTok{Pima.te}\OperatorTok{$}\NormalTok{type])}\OperatorTok{/}\KeywordTok{dim}\NormalTok{(Pima.te)[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-273-2.pdf}
...
14 0.00000000000000000000000000000000000001748
\end{verbatim}
...
\section{Practice Exercise}\label{practice-exercise-14}
...
\OperatorTok{+}\StringTok{       }\KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The number of HEADS out of"}\NormalTok{, n, }
\OperatorTok{+}\StringTok{         "tosses is"}\NormalTok{, df}\OperatorTok{$}\NormalTok{numheads[i]))}
\OperatorTok{+}\StringTok{     }\NormalTok{\}}
\OperatorTok{+}\StringTok{   }\NormalTok{\}}
\OperatorTok{+}\StringTok{   }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ numheads)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\begin{verbatim}
Warning in rbinom(1, n, 0.5): '.Random.seed[1]' is not
a valid integer, so ignored
\end{verbatim}
...
\begin{verbatim}
[1] "The number of HEADS out of 25 tosses is 15"
[1] "The number of HEADS out of 25 tosses is 11"
[1] "The number of HEADS out of 25 tosses is 8"
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\NormalTok{strings <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Once-upon"}\NormalTok{, }\StringTok{"a.time"}\NormalTok{, }\StringTok{"there"}\NormalTok{, }\StringTok{"was-a"}\NormalTok{, }\StringTok{"man.named"}\NormalTok{, }
\OperatorTok{+}\StringTok{   "Bob"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Unit: nanoseconds
  ...
  sum(x)   986  1068   1465   1111   1386   18518
 sumC(x)  2320  2506  12825   2638   2930  980317
 sumR(x) 97415 98485 145716 103768 116487 3348692
 neval
   100
   100
   100
...
\begin{verbatim}
 [1] 363 568 594 554 411 441 589 561 549 420
\end{verbatim}
...
(here){[}\url{http://www.sqlitetutorial.net/sqlite-sample-database/}{]}
...
\OperatorTok{+}\StringTok{   }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(LastName, FirstName, Phone, Email) }\OperatorTok{%>%}\StringTok{ }
...
8 Peacock  Jane      +1 (403) 262-~ jane@chinookcorp.~
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\NormalTok{employees }\OperatorTok{%>%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Title }\OperatorTok{==}\StringTok{ "Sales Support Agent"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(LastName, FirstName, Address) }\OperatorTok{%>%}\StringTok{ }
\OperatorTok{+}\StringTok{   }\KeywordTok{arrange}\NormalTok{(LastName)}
\end{Highlighting}
\end{Shaded}
...
the \href{http://db.rstudio.com/}{RStudio Databases using R page}. But
while doing this, keep in mind that we (and R Studio) both recommend
...
sine curve plotted in @ref(fig:analogsignal\}. Notice that the sine
curve is defined for every value on the interval from 0 to 2\(\pi\).
...
\item
  \textbf{Filters}: filters allow you to remove out specific portions of
  a signal at once, or allow you to remove noise from certain signals.
\end{enumerate}
...
When working with sound (or any type of signal) you often have to
consider whether or not you want to be working in the \emph{time domain}
or the \emph{frequency domain}. These two different domains can provide
valuable information about a signal. The most popular way to explore
signals in the frequency domain is to use Fourier Transforms. A
\emph{Fourier Transform} is a reversible mathematical transform
developed by Joseph Fourier in the early 1800s. The transform breaks
apart a time series into a sum of finite series of sine or cosine
functions. This was a huge break through of it's time, as Fourier argues
that any signal can be broken down into a series of sine and cosine
curves. This was a fantastic development and is still one of the most
widely used tools in digital signal processing, which tells you how
useful it truly is (and how brilliant Fourier was).
...
\includegraphics[width=5cm]{bookdown_files/figure-latex/unnamed-chunk-353-1}
...
birds that are fairly commonly in rural and suburban areas (Figure
...
There are \texttt{table(cedarWax\$Vocalization\_type){[}"call"{]}}
recordings labeled as ``call'' so we will just focus on these
recordings, but keep in mind that in a more serious study, we may want
to manipulate the labels and combine vocalizations that are actually of
the same type.
...
recordings to minimize downloading and computation time.\footnote{Sound
  ...
  package can be time consuming.} \texttt{warbleR} and \texttt{seewave}
are designed to work with wav files while the xeno-canto database stores
its recordings as mp3 files. Luckily there is a very simple function
\texttt{mp32wav} that converts all the mp3 files in the working
directory to wav files. We then remove all the mp3 files from the
current directory using the \texttt{system} function.

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\NormalTok{newCedarWax <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(cedarWax, cedarWax}\OperatorTok{$}\NormalTok{Recording_ID }\OperatorTok{%in%}\StringTok{ }
...
We will do this using a process called Principal Components Analysis.
For now don't focus on the details of this procedure, and rather focus
on the results.

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\CommentTok{# Remove the non-numeric variables and then run the pca}
\ErrorTok{>}\StringTok{ }\NormalTok{pca <-}\StringTok{ }\KeywordTok{prcomp}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ finalData[, }\KeywordTok{sapply}\NormalTok{(finalData, is.numeric)], }
\OperatorTok{+}\StringTok{   }\DataTypeTok{scale. =} \OtherTok{TRUE}\NormalTok{)}
...
\OperatorTok{>}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ score, }\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(PC1, PC2)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{color =}\NormalTok{ finalData}\OperatorTok{$}\NormalTok{Recording_ID, }
\OperatorTok{+}\StringTok{   }\DataTypeTok{shape =}\NormalTok{ finalData}\OperatorTok{$}\NormalTok{Country))}
\end{Highlighting}
\end{Shaded}

\includegraphics{bookdown_files/figure-latex/unnamed-chunk-366-1.pdf}

Well from the graph we see that two birds from the US form a group with
a bird from Mexico, and a bird from the US forms a group with a bird
